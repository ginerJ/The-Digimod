...
import static net.modderg.thedigimod.gui.StatsGui.renderAnalysisGui;
import static net.modderg.thedigimod.gui.CommandsGui.renderCommands;
...
public class DigiviceScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (targetDigimon instanceof CustomDigimon cd) {
            renderAnalysisGui(guiGraphics, width, height, cd);
        }
