...
public class DigitalFollowOwnerGoal extends Goal {
    ...
    private final DigimonEntity tamable;
    ...
    public DigitalFollowOwnerGoal(DigimonEntity p_25294_, double p_25295_, float p_25296_, float p_25297_, boolean p_25298_) {
    ...
    public void start() {
        ...
        if(!(tamable instanceof SwimmerDigimonEntity)){
    ...
    private boolean canTeleportTo(BlockPos p_25308_) {
        ...
        if ((!(tamable instanceof SwimmerDigimonEntity) || blockpathtypes != BlockPathTypes.WATER) && blockpathtypes != BlockPathTypes.WALKABLE) {
            return false;
        } else {
