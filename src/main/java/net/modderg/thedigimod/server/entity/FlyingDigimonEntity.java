...
public class FlyingDigimonEntity extends DigimonEntity implements PlayerRideableJumping {
    protected FlyingDigimonEntity(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
    ...
    public static <T extends DigimonEntity & GeoEntity> AnimationController<T> flyingAnimController(T digimon) {
