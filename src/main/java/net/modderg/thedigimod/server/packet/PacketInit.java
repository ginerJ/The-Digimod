...
public class PacketInit {
    ...
    public static void register(){
        ...
        INSTANCE.messageBuilder(CToSWriteDataToDigimonJsons.class, id++)
                ...
                .consumerMainThread(CToSWriteDataToDigimonJsons::handle)
                .add();

        INSTANCE.messageBuilder(StoCGetTreeStringsPacket.class, id++)
                .encoder(StoCGetTreeStringsPacket::encode)
                .decoder(StoCGetTreeStringsPacket::new)
                .consumerMainThread(StoCGetTreeStringsPacket::handle)
                .add();

        INSTANCE.messageBuilder(CToSGetTreeStringsPacket.class, id++)
                .encoder(CToSGetTreeStringsPacket::encode)
                .decoder(CToSGetTreeStringsPacket::new)
                .consumerMainThread(CToSGetTreeStringsPacket::handle)
                .add();

        INSTANCE.messageBuilder(CToSSetRollFirstEvoPacket.class, id++)
                .encoder(CToSSetRollFirstEvoPacket::encode)
                .decoder(CToSSetRollFirstEvoPacket::new)
                .consumerMainThread(CToSSetRollFirstEvoPacket::handle)
                .add();
    }
