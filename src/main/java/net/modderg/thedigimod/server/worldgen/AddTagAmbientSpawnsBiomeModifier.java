...
public record AddTagAmbientSpawnsBiomeModifier(HolderSet<Biome> biomes, int weight, int minCount, int maxCount, TagKey<EntityType<?>> entityTag) implements BiomeModifier {
    ...
    public void modify(Holder<Biome> biome, Phase phase, Builder builder) {
        ...
        for (EntityType<?> entityType : ForgeRegistries.ENTITY_TYPES.tags().getTag(this.entityTag)) {
            ...
            spawns.addSpawn(MobCategory.AMBIENT, spawnerData);
        }
    }
