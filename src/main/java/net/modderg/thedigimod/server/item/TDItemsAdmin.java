...
public class TDItemsAdmin {
    ...
    public static final RegistryObject<Item> POOP_DATA = CREATIVE_ITEMS.register("poop_data", () -> new CustomXpItem(new Item.Properties(), 9,1));
    ...
    public static final RegistryObject<Item> POOP_PACK = CREATIVE_ITEMS.register("poop_pack", () -> new CustomXpItem(new Item.Properties(), 9,9));
    ...
    public static final RegistryObject<Item> ATTACK_GB = CREATIVE_ITEMS.register("gbattack", () -> new StatUpItem(new Item.Properties().stacksTo(1), "attack", DigimonEntity.MAX_MEGA));
    public static final RegistryObject<Item> DEFENCE_GB = CREATIVE_ITEMS.register("gbdefence", () -> new StatUpItem(new Item.Properties().stacksTo(1), "defence", DigimonEntity.MAX_MEGA));
    public static final RegistryObject<Item> SPATTACK_GB = CREATIVE_ITEMS.register("gbspattack", () -> new StatUpItem(new Item.Properties().stacksTo(1), "spattack", DigimonEntity.MAX_MEGA));
    public static final RegistryObject<Item> SPDEFENCE_GB = CREATIVE_ITEMS.register("gbspdefence", () -> new StatUpItem(new Item.Properties().stacksTo(1), "spdefence", DigimonEntity.MAX_MEGA));
    public static final RegistryObject<Item> HEALTH_DRIVES = CREATIVE_ITEMS.register("health_drives", () -> new StatUpItem(new Item.Properties().stacksTo(1), "health", DigimonEntity.MAX_MEGA));
