...
public class StatUpItem extends DigimonItem {
    ...
    public @NotNull InteractionResult interactLivingEntity(@NotNull ItemStack item, @NotNull Player player, @NotNull LivingEntity entity, @NotNull InteractionHand hand) {
        if(entity instanceof DigimonEntity cd && (player.isCreative() || cd.isTame())){
            ...
            if(player instanceof ServerPlayer sp)
                TDAdvancements.grantAdvancement(sp, TDAdvancements.SHORTCUTS);
    ...
    @Override
    public void appendHoverText(@NotNull ItemStack p_41421_, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
