...
public class CustomDigimonRender<D extends CustomDigimon> extends GeoEntityRenderer<CustomDigimon> {
    ...
    @Override
    public void render(@NotNull CustomDigimon entity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn) {
    ...
    protected void renderDigimonInfo(CustomDigimon entity, float partialTicks, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn){
    ...
    protected void renderHover(CustomDigimon p_114498_, Component p_114499_, PoseStack stack, MultiBufferSource p_114501_, int p_114502_ , float heightAdd) {
