...
public class CustomSwimmerDigimon extends CustomDigimon {
    protected CustomSwimmerDigimon(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
    ...
    public static <T extends CustomDigimon & GeoEntity> AnimationController<T> waterAnimController(T digimon) {
