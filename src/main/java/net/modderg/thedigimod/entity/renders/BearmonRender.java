...
public class BearmonRender extends CustomDigimonRender<DigimonBearmon> {

    public BearmonRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, (AnimatedGeoModel<CustomDigimon>) new BearmonModel());
    }
}
