...
import net.modderg.thedigimod.entity.models.TsunomonModel;
import software.bernie.geckolib3.model.AnimatedGeoModel;
import software.bernie.geckolib3.renderers.geo.GeoEntityRenderer;

public class TsunomonRender extends CustomDigimonRender<DigimonTsunomon> {

    public TsunomonRender(EntityRendererProvider.Context renderManager){
        super(renderManager, (AnimatedGeoModel<CustomDigimon>) new TsunomonModel());
    }
}
