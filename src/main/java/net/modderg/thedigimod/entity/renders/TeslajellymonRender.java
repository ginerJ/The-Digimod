...
import net.modderg.thedigimod.entity.models.TeslajellymonModel;
import software.bernie.geckolib3.model.AnimatedGeoModel;
import software.bernie.geckolib3.renderers.geo.GeoEntityRenderer;

public class TeslajellymonRender extends CustomDigimonRender<DigimonTeslajellymon> {

    public TeslajellymonRender(EntityRendererProvider.Context renderManager){
        super(renderManager, (AnimatedGeoModel<CustomDigimon>) new TeslajellymonModel());
    }
