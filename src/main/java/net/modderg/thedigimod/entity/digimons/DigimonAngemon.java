...
public class DigimonAngemon extends CustomDigimon {

    public DigimonAngemon(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
        super(p_21803_, p_21804_);
        this.idleAnim = "idle8";
        this.walkAnim = "walk7";
        this.sitAnim = "sit9";
        this.flyAnim = "float";
        this.attackAnim = "attack8";
    }
