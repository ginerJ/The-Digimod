...
public class DigimonTokomon extends CustomDigimon {

    public DigimonTokomon(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
    ...
    protected EntityType evoPath() {
        return DigitalEntities.PATAMON.get();
    }
    @Override
