...
public class DigimonGoromon extends CustomDigimon {

    public DigimonGoromon(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
    ...
    protected EntityType evoPath() {
        return DigitalEntities.SUNARIZAMON.get();
    }
    @Override
