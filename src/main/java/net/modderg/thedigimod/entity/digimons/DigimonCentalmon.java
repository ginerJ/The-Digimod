...
public class DigimonCentalmon extends CustomDigimon {

    public DigimonCentalmon(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
    ...
    @Override
    public RegistryObject<?> getXpDrop() {return DigiItems.MACHINE_DATA;}
}
