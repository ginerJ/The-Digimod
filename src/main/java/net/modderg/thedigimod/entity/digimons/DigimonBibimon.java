...
public class DigimonBibimon extends CustomDigimon {

    public DigimonBibimon(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
    ...
    protected EntityType evoPath() {
        return DigitalEntities.PULSEMON.get();
    }
    @Override
