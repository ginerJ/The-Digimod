...
public class ModCommonConfigs {
    ...
    static {
        ...
        CAN_SPAWN_DIGIMON = BUILDER.comment("Side note: disabling working is not a config, it can be turned off by setting mob griefing to false \nallows digimon to spawn in the overworld")
        ...
        CHANCE_DROP_FOOD = BUILDER
                .define("chance of digi food drop:", 10);
        CHANCE_DROP_CARD = BUILDER
                .define("chance of green card drop:", 10);
